...
AudioOutputI2S           i2s1;           //xy=1208.333251953125,465.66668701171875
...
AudioConnection          patchCord21(VCO_MIX_FINAL, 0, i2s1, 0);
AudioConnection          patchCord22(VCO_MIX_FINAL, 0, i2s1, 1);
